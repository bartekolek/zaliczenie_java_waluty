...
import com.example.zaliczenie_apka_waluty.TrzeciaAktywnosc.Th_froint;

public class Second_froint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_euro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Second_froint.this, Th_froint.class);
