...
import com.example.zaliczenie_apka_waluty.TrzeciaAktywnosc.Th_korona_czeska;

public class Second_korona_czeska extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_korona_czeska);
        ...
        btn_euro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Second_korona_czeska.this, Th_korona_czeska.class);
