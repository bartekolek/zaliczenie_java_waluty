...
import com.example.zaliczenie_apka_waluty.TrzeciaAktywnosc.Th_korona_szwedzka;

public class Second_korona_szwedzka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_korona_szwedzka);
        ...
        btn_euro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Second_korona_szwedzka.this, Th_korona_szwedzka.class);
