...
import com.example.zaliczenie_apka_waluty.TrzeciaAktywnosc.Th_kuna;

public class Second_kuna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_kuna);
        ...
        btn_euro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Second_kuna.this, Th_kuna.class);
