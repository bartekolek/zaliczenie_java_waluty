...
import com.example.zaliczenie_apka_waluty.TrzeciaAktywnosc.Th_lej;

public class Second_lej extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_lej);
        ...
        btn_euro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Second_lej.this, Th_lej.class);
