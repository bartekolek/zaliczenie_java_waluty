...
import com.example.zaliczenie_apka_waluty.TrzeciaAktywnosc.Th_lew;

public class Second_lew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_lew);
        ...
        btn_euro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Second_lew.this, Th_lew.class);
