...
public class Th_korona_szwedzka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (waluta.equals("SEK")) {

                nazwa.setText(wynik + " SEK = " + wynik + " SEK");
            } else if (waluta.equals("BGN")) {
                double wynik_koncowy = wynik_double * 0.19;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " BGN");
            } else if (waluta.equals("RON")) {
                double wynik_koncowy = wynik_double * 0.48;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " RON");
            } else if (waluta.equals("HRK")) {
                double wynik_koncowy = wynik_double * 0.73;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " HRK");
            } else if (waluta.equals("CZK")) {
                double wynik_koncowy = wynik_double * 2.42;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " CZK");
            } else if (waluta.equals("DKK")) {
                double wynik_koncowy = wynik_double * 0.72;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " DKK");
            } else if (waluta.equals("EUR")) {
                double wynik_koncowy = wynik_double * 0.10;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " EUR");
            } else if (waluta.equals("HUF")) {
                double wynik_koncowy = wynik_double * 35.75;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " HUF");
            } else if (waluta.equals("PLN")) {
                double wynik_koncowy = wynik_double * 0.45;
                nazwa.setText(wynik + " SEK = " + wynik_koncowy + " PLN");
            }
        ...
        cofanie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Th_korona_szwedzka.this, MainActivity.class);
